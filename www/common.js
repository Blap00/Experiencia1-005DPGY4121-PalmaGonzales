...
/***/ 1754:
/*!*************************************************!*\
  !*** ./src/app/services/usuario-alu.service.ts ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "UsuarioAluService": () => (/* binding */ UsuarioAluService)
/* harmony export */ });
...
let UsuarioAluService = class UsuarioAluService {
  constructor(storage) {
  ...
  addDatos(dato) {
    ...
    return (0,C_Users_56941_Dropbox_PC_Desktop_Ionic_sandbox_PGY4121_Experiencia1_005D_Caso_A_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return _this2.storage.get(ITEMS_KEY).then(datos => {
        if (datos) {
          //Implementamos el metodo push para agregar un objeto a una coleccion con Keys y valor
          datos.push(dato);
          return _this2.storage.set(ITEMS_KEY, datos);
        } else {
          return _this2.storage.set(ITEMS_KEY, [dato]);
        }
      });
    })();
  } //Leer Datos:
  ...
  updateDatos(dato) {
    ...
    return (0,C_Users_56941_Dropbox_PC_Desktop_Ionic_sandbox_PGY4121_Experiencia1_005D_Caso_A_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return _this3.storage.get(ITEMS_KEY).then(datos => {
        if (!datos || datos.length == 0) {
          return null; //si la coleccion no contiene ningun dato, esta pregunta devolvera Falso y no devolvera nada
        }

        let newDato = []; //creamos una nueva coleccion y luego buscaremos el valor a actualizar mediante su KEY
        ...
        return _this3.storage.set(ITEMS_KEY, newDato); //modificamos el Storage con los datos seleccionados
      });
    })();
  } //delete:
  ...
  deleteDatos(id) {
    ...
    return (0,C_Users_56941_Dropbox_PC_Desktop_Ionic_sandbox_PGY4121_Experiencia1_005D_Caso_A_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      //Se captura desde el objeto storage, a través del método get, lasclaves de los objetos almacenados.
      return _this4.storage.get(ITEMS_KEY).then(datos => {
        if (!datos || datos.length == 0) {
          return null; //Comprobamos si la colección tiene o no objetos y devuelva nullen caso de que corresponda.
        ...
        for (let i of datos) {
          if (i.id !== id) {
            toKeep.push(i); //Devolvemos al set de Keys, la colección con los objetos noeliminados.
          }
        }

        return _this4.storage.set(ITEMS_KEY, toKeep);
      });
    })();
  }
...
UsuarioAluService.ctorParameters = () => [{
  type: _ionic_storage__WEBPACK_IMPORTED_MODULE_1__.Storage
}];

UsuarioAluService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
  providedIn: 'root'
})], UsuarioAluService);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,C_Users_56941_Dropbox_PC_Desktop_Ionic_sandbox_PGY4121_Experiencia1_005D_Caso_A_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,C_Users_56941_Dropbox_PC_Desktop_Ionic_sandbox_PGY4121_Experiencia1_005D_Caso_A_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,C_Users_56941_Dropbox_PC_Desktop_Ionic_sandbox_PGY4121_Experiencia1_005D_Caso_A_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
